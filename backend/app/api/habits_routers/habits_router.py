"""
Агрегирующий роутер для управления привычками.

Объединяет все эндпоинты, связанные с созданием, просмотром, редактированием,
удалением привычек, отметкой их выполнения, а также внутренние сервисные
эндпоинты (перенос привычек и напоминания), под общим префиксом /habits.
"""
